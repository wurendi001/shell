...
echo && echo -e " tinyPortMapper 失落的梦 端口转发一键管理脚本 ${Red_font_prefix}[v${sh_ver}]${Font_color_suffix}
 "———————————————————————————————————————————————————————————————————————————————————— "
  1.youtube关注:https://www.youtube.com/channel/UCmteg7BSPK8pTFvKAlkBoEw
  2.博客关注:https://www.kehu33.asia
  3.微信：Falltoher-1314
  4.QQ: 1150315739  
  5.近期将更新本脚本功能2023/2/12
 "———————————————————————————————————————————————————————————————————————————————————— "
